...
function InitProjectNames($complateJobNos)
{
	...
	{
		$str .= '
		<td colspan="4" align="center">' . $conf['districtName'][$v] . '</td>';
	}
	return $str;
}
...
function InitProjectTitles($complateJobNos)
{
	...
	{
		$str .= '
	<td align="center">小時</td>
    <td align="center">學費</td>
    <td align="center">付款</td>
    <td align="center">餘額</td>';
	}
	return $str;
}
...
$t->set_file ( "HdIndex", "survey_salary.html" );
...
// Other projects
$salaryType = "surveyor";
$sql = "SELECT surveyorId as surveyorCode,engName,projectCode AS complateJobNo,SUM(wages) AS totalWages
	...
	INNER JOIN Survey_Surveyor ON surveyorId=survId
	WHERE 1=1
