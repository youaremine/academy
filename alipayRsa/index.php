 ...
 *Function:Alipay create_forex_trade_wap debugging 
...
<head>
	...
	<title>create_forex_trade_wap</title>
</head>
...
<body>
	<div class="header">
		...
		<div class="container blue">
			<div class="title">create_forex_trade_wap</div>
		</div>
	</div>
	<div class="content">
		<form action="alipayapi.php" class="alipayform" method="post" target="_blank">
			<div class="element" style="margin-top:60px;">
				<div class="legend">create_forex_trade_wap</div>
			</div>
			...
			<div class="element" align="left">
				...
				<div class="einput"><input type="text" name="currency" value="HKD"></div>
				<br>
			...
			<div class="element" align="left">
		                ...
		                <br>
		                <div class="mark">注意：NEW_WAP_OVERSEAS_SELLER</div>
		     </div>
		     <div class="element" align="left">
			...
			<div class="element" align="margin">
